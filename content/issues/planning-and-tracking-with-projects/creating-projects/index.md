...
delete b;
// sets to initial value, set all variabl

es in struct to 0, except mappings
...
// '_' (underscore) often included as last line in
...
estrict human or computer from reading contents of
